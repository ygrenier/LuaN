...
namespace LuaN.DllWrapper
{
    ...
    using LUAI_UACNUMBER = Double;
    using LUA_NUMBER = Double;
    using LUA_UNSIGNED = UInt64; //unsigned LUAI_UACINT;
    using LUA_KCONTEXT = Int64;
    using LUAI_UACINT = Int64;
    ...
    public static partial class LuaDll
    {
        ...
        */
        ...
        //const bool LUA_USE_WINDOWS = true;
        //#endif


        //#if defined(LUA_USE_WINDOWS)
        //#define LUA_DL_DLL	/* enable support for DLL */
        //const bool LUA_DL_DLL = true;
        //#define LUA_USE_C89	/* broadly, Windows is C89 */
        //const bool LUA_USE_C89 = true;
        //#endif
        ...
        */
        ...
        //const bool LUA_INT_LONGLONG = true;
        //#define LUA_REAL_DOUBLE
        //const bool LUA_REAL_DOUBLE = true;
        ...
        */
        ...
        public const String LUA_NUMBER_FMT_NET = "g14";
        ...
        public static LUA_NUMBER l_floor(LUA_NUMBER x) { return Math.Floor(x); }
        ...
        public static String lua_number2str(LUA_NUMBER n) { return n.ToString(LUA_NUMBER_FMT_NET, CultureInfo.InvariantCulture); }
        ...
        */
        ...
        public const String LUA_INTEGER_FMT_NET = "D";
        ...
        public static String lua_integer2str(LUA_INTEGER n) { return n.ToString(LUA_INTEGER_FMT_NET, CultureInfo.InvariantCulture); }

        //using LUAI_UACINT		=LUA_INTEGER;

        /*
        ** use LUAI_UACINT here to avoid problems with promotions (which
        ** can turn a comparison between unsigneds into a signed comparison)
        */
        //using LUA_UNSIGNED		=unsigned LUAI_UACINT;
        ...
        //using LUA_INTEGER		=Int64;
        public const String LUA_INTEGER_FRMLEN = "l";

        public const Int64 LUA_MAXINTEGER = Int64.MaxValue;
        public const Int64 LUA_MININTEGER = Int64.MinValue;
        ...
        */
        public static readonly int LUAL_BUFFERSIZE = (0x80 * IntPtr.Size * sizeof(LUA_INTEGER));	//((int)(0x80 * sizeof(void*) * sizeof(lua_Integer)))
        ...
        ** compatibility only.
        */
        public static String LUA_QL(String x) { return String.Format("'{0}'", x); }
        public static readonly String LUA_QS = LUA_QL("%s");
